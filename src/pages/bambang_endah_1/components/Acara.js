        ...
        <section ref={sectionRef} style={styles.section}> 
            <Box sx={styles.box}> 
                ...
                <Grid container spacing={4} style={{ position: 'relative', marginTop: windowWidth < 600 ? '10%' : `${18-windowWidth*0.005}%`, marginLeft: '0%', justifyContent: 'center' }}>
                    <Grid data-aos='fade-right' data-aos-duration="1500"  item xs={12} sm={12} md={5} style={styles.gridItem}>
                        <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center'}}>
                            <h2 className="font-serif" style={styles.txt.header}>Akad Nikah</h2>
                            <img src={ring} style={{width: `${18+windowWidth*0.003}%`}}/>
                        </div>
                        <hr style={styles.hr} />
                        <br/>
                        <div style={{display: 'flex', justifyContent: 'center', alignItems: 'end'}}>
                            <img src={bgcard1} style={styles.bgcard}></img>
                            <p style={{...styles.txt, position: 'absolute', marginBottom: '7%', fontWeight: 'bold'}}>Minggu, 14 Mei 2023<br/>08.00 s/d 10.00</p>
                        </div>
                        <br/>
                    ...
                    <Grid item />
                    <Grid data-aos='fade-left' data-aos-duration="1500" item xs={12} sm={12} md={5} style={styles.gridItem}>
                        <h2 className="font-serif" style={styles.txt.header}>Resepsi Pernikahan</h2>
                        <hr style={styles.hr} />
                        <br/>
                        <div style={{display: 'flex', justifyContent: 'center', alignItems: 'end'}}>
                            <img src={bgcard2} style={styles.bgcard}></img>
                            <p style={{...styles.txt, position: 'absolute', marginBottom: '7%', fontWeight: 'bold'}}>Minggu, 14 Mei 2023<br/>11.30 s/d selesai</p>
                        </div>
                        <br/>
                        <Box style={{ padding: windowWidth > 600 ? '1% 5% 5% 5%' : '1% 5% 5% 5%'}}>
                            <p style={styles.txt}>
                ...
                <Box style={styles.countdown}>
                    <h2 className="font-serif" style={styles.txt.header}>Menghitung Hari</h2>
                    <hr style={styles.hr} />
                    <p style={styles.txt}>menuju hari bahagia</p>
                    <br/>
                    <Button variant="contained" onClick={handleCalClick} style={styles.btnStyles}>
                        <EditCalendarRounded style={{ marginRight: '7px', fontSize: '1rem' }} />
                        Simpan ke Kalender
                    </Button>
                    <br/>
                    <Box className='font-serif' sx={{display: 'flex', width: `${95-windowWidth*0.035}%`, justifyContent: 'space-between'}}>
                    <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                            ...
                            <p style={{...styles.txt, fontSize: '100%', marginTop: `${12-windowHeight*0.006}vh`}}>Hari</p>
                        </Box>
                        <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                            <AnimatePresence>
                                <motion.p 
                            ...
                            <p style={{...styles.txt, fontSize: '100%', marginTop: `${12-windowHeight*0.006}vh`}}>Jam</p>
                        </Box>
                        <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                            <AnimatePresence>
                                <motion.p 
                            ...
                            <p style={{...styles.txt, fontSize: '100%', marginTop: `${12-windowHeight*0.006}vh`}}>Menit</p>
                        </Box>
                        <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                            <AnimatePresence>
                                <motion.p 
                            ...
                            <p style={{...styles.txt, fontSize: '100%', marginTop: `${12-windowHeight*0.006}vh`}}>Detik</p>
                        </Box>
                    </Box>
                    <br/>
