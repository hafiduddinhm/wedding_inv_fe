...
const OpeningModal = () => {
    ...
    const namatamu = 'Bu Fitri Nurwijayanti, S. Pd'
    ...
    return (
        <Modal isOpen={isOpen} onRequestClose={closeModal} closeTimeoutMS={500} style={modalStyles}>
            <Box style={boxStyles}>
                ...
                <h1 style={{...styles.txt1, textAlign: 'end', justifySelf: 'right'}} className="font-estetik">Save the<br/>Date</h1>
                <img src={letterOrnament} style={styles.letterOrnament}/>
                <Box style={styles.box2}>
                    <Box sx={{marginBottom: '3vh'}}>
                        <h1 style={styles.txt2}>The Wedding of</h1>
                        <h1 style={{...styles.txt1, fontSize: `${2.2+windowWidth*0.001}rem`}}>Rika & Lilik</h1>
                    </Box>
                    <Box sx={{marginBottom: '4vh'}}>
                        {guest != null && 
                            <>
                                <h1 style={styles.txt2}>Kepada Bapak/Ibu/Saudara/i</h1>
                                <h1 style={{...styles.txt2, fontWeight: 'bold'}}>{guest}</h1>
                            </>
                        }
                        {guest === null && 
                            <><br/></>
